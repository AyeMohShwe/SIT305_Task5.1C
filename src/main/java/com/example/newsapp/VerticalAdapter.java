...
public class VerticalAdapter extends RecyclerView.Adapter<VerticalAdapter.VerticalViewHolder>{
    private List<com.example.newsapp.Vertical> verticalList;
    private Context context;
    private OnRowClickListener listener;

    public VerticalAdapter(List<com.example.newsapp.Vertical> verticalList, Context context, OnRowClickListener listener) {
